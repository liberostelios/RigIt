...
class PlayerEntry(StoredDataStructure):
    _struct = struct.Struct("<iiHBBBBHIIIIHHIHHII46s16s3s")
    _attributes = {}
    ...
    def fromBytearray(self, data): #TODO: check size beforehand
        ...
        self._playingStyle = PlayingStyle.NONE # PlayingStyle.fromGameId(data[12] >> 11 & 0b11111)
