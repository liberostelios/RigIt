...
class PlayerEntry(StoredDataStructure):
    #                         4421111244442242244
    _struct = struct.Struct("<iiHBBBBHIIIIIIHHII46s16s3s")
    _attributes = {}
    ...
    _attributes['bodyControl'] = (7, 0, 80)
    ...
    _attributes['setPieceTaking'] = (7, 0, 80)
    ...
    def fromBytearray(self, data): #TODO: check size beforehand
        ...
        self._nationalityRegion = NationalityRegion.fromGameId(data[2]) # 0x8
        self._height = data[3] # 0xa
        self._weight = data[4] # 0xb
        self._motionGoalCelebration1 = data[5] # 0xc
        self._motionGoalCelebration2 = data[6] # 0xd
        self._attackingProwess = data[7] & 0b1111111 # 0xe
        self._ballControl = data[7] >> 7 & 0b1111111
        self._lowPass = data[8] & 0b1111111 # 0x10
        self._loftedPass = data[8] >> 7 & 0b1111111
        self._finishing = data[8] >> 14 & 0b1111111
        self._setPieceTaking = data[8] >> 21 & 0b1111111
        self._motionFreeKick = data[8] >> 28 & 0b1111
        self._header = data[9] & 0b1111111 # 0x14
        self._defensiveProwess = data[9] >> 7 & 0b1111111
        self._ballWinning = data[9] >> 14 & 0b1111111
        self._kickingPower = data[9] >> 21 & 0b1111111
        self._form = data[9] >> 28 & 0b111
        self._editedCreatedPlayer = data[9] >> 31 & 0b1
        self._explosivePower = data[10] & 0b1111111 # 0x18
        self._bodyControl = data[10] >> 7 & 0b1111111
        self._physicalContact = data[10] >> 14 & 0b1111111
        self._jump = data[10] >> 21 & 0b1111111
        self._injuryResistance = data[10] >> 28 & 0b11
        self._unknownC = data[10] >> 30 & 0b11
        self._catching = data[11] & 0b1111111 # 0x1c
        self._clearing = data[11] >> 7 & 0b1111111 #TODO: PHYSICAL CONTACT
        self._reflexes = data[11] >> 14 & 0b1111111
        self._coverage = data[11] >> 21 & 0b1111111
        ...
        self._playingStyle = PlayingStyle.NONE # PlayingStyle.fromGameId(data[12] >> 11 & 0b11111) TODO
        self._curve = data[12] >> 15 & 0b1111111
        self._speed = data[12] >> 22 & 0b1111111
        self._weakFootAccuracy = data[12] >> 14 & 0b11
        self._stamina = data[13] & 0b1111111
        self._dribbling = data[13] >> 17 & 0b1111111
        self._motionArmMovementRunning = data[13] >> 7 & 0b111 # TODO
        self._motionCornerKick = data[13] >> 10 & 0b111 # TODO
        self._goalkeeping = data[13] >> 7 & 0b1111111
        self._weakFootUsage = data[13] >> 20 & 0b11
        self._goalkeeper = data[13] >> 28 & 0b11
        self._centreBack = data[13] >> 30 & 0b11
        self._leftBack = data[14] & 0b11
        self._rightBack = data[14] >> 2 & 0b11
        self._defensiveMidfielder = data[14] >> 4 & 0b11
        self._centreMidfielder = data[14] >> 6 & 0b11
        self._leftMidfielder = data[14] >> 8 & 0b11
        self._rightMidfielder = data[14] >> 10 & 0b11
        self._attackingMidfielder = data[14] >> 12 & 0b11
        self._rightWingForward = data[14] >> 14 & 0b11
        self._leftWingForward = data[15] & 0b11
        self._secondStriker = data[15] >> 2 & 0b11
        self._centreForward = data[15] >> 4 & 0b11
        self._age = data[15] >> 10 & 0b111111
        self._motionHunchingDribbling = data[15] & 0b11
        self._motionHunchingRunning = data[15] >> 2 & 0b11
        self._motionPenaltyKick = data[15] >> 4 & 0b11
        self._unknownF = data[15] >> 6 & 0b1111111111
        # self._unknownF = data[16] >> 13 & 0b111
        self._unknownA = data[16] & 0b1111111
        self._unknownG = data[16] >> 14 & 0b11111
        self._strongerFoot = StrongerFoot.fromGameId(data[17] >> 19 & 0b1)
        self._unknownH = data[16] >> 20 & 0b1
        comPlayingStyle = data[16] >> 21 & 0b1111111 #TODO: verify order
        ...
        playerSkills = (data[17] << 32 | data[16]) >> 28 & 0xFFFFFFF #TODO: verify order
